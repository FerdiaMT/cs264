...
int main()
{
    std::cout << "=== Testing Module and Programme System ===" << std::endl;
    ...
    {
        std::cout << "CS264 and testModule2 are Different" << std::endl;
    }

    if (!(cs264 == cs357))
    {
        std::cout << "CS264 and cs357 are Different " << std::endl;
    }
    std::cout << std::endl;
